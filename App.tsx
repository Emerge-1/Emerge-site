  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-slate-700 selection:text-white overflow-x-hidden">
      ...
      <main className="relative z-10">
        ...
        <section id="demo" className="py-16 md:py-24 bg-[#050505]/90 border-y border-white/5 backdrop-blur-md overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
              <div className="overflow-hidden">
                ...
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 tracking-tight">Spectral-Native Models</h3>
                <p className="text-slate-400 mb-8 md:mb-10 leading-relaxed text-sm sm:text-base md:text-lg font-light break-words">
              ...
              <div className="relative aspect-square max-w-sm sm:max-w-lg mx-auto lg:max-w-none">
                <IntelligenceDemo />
              </div>
            </div>
          </div>
